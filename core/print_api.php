...
function print_captcha_input( $p_field_name ) {
	echo '<input type="text" style="text-align:center" name="' . $p_field_name . '" size="15" placeholder="' . lang_get( 'signup_captcha_request' ) . '" value="" minlength="10" maxlength="10" required/>';
}
