...
<div style="width:500px;margin:20% auto;background:#f7f7f7;box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.3);padding-bottom:5px">
	...
	<div align="center" style="padding:5px">	
		<?php echo lang_get( 'reset_request_in_progress_msg' ) ?><br ><br ><p><b>
		<?php print_bracket_link( 'login_page.php', lang_get( 'proceed' ) ); ?></b></p>
	</div>
</div>
