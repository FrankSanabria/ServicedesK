...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	 ...
	 */
	$g_disallowed_files		= 'ade,adp,app,bas,bat,chm,cmd,com,cpl,crt,csh,exe,fxp,hlp,hta,inf,ins,isp,js,jse,ksh,lnk,mda,mdb,mde,mdt,mdw,mdz,msc,msi,msp,ops,pcd,pif,prf,prg,reg,scf,scr,sct,shb,shs,url,vb,vbe,vbs,wsc,wsf,wsh,xsl';
	 ...
	 */
	$g_html_valid_tags		= 'p, li, ul, ol, br, pre, i, b, u, em, strong, span, h1, h2, h3';
...
*/
	 ...
	 */
	$g_log_destination = 'file:/tmp/mantisbt_frank';
