...
html_page_top( 'Test ServicedesK' );
...
<div align="center">
		[ <a href="check.php">Check your installation</a> ]
	<?php if ( count($upgrade) - 1 != config_get( 'database_version' ) ) { ?>
		[ <a href="upgrade_warning.php"><b>Upgrade your installation</b></a> ]
	<?php } ?>
		[ <a href="system_utils.php">System Utilities</a> ]
		[ <a href="test_icons.php">Test Icons</a> ]
		[ <a href="test_langs.php">Test Langs</a> ]
		[ <a href="test_email.php">Test Email</a> ]
		[ <a href="email_queue.php">Email Queue</a> ]
</div>
