...
<tr class="row-1">
	...
	<td width="75%">
		<input type="text" name="question" size="80" maxlength="255" value="<?php echo $v_question ?>" required>
	</td>
</tr>
<tr class="row-2">
	<td class="category">
	...
	<td>
		<textarea   id="editor1"  name="answere" cols="80" rows="10" wrap="virtual"> <?php echo $v_answere ?></textarea>
	</td>
</tr>
