...
class FAQPlugin extends MantisPlugin {
  ...
  function register() {
    $this->name        = 'FAQ';
    $this->description =  lang_get( 'plugin_FAQ_description' );
    $this->version     = '1.02';
    $this->requires    = array('MantisCore' => '1.2.0',);
    $this->author      = 'Frank Sanabria and Cas Nuy / based upon scripts from pbia@engineer.com ';
  ...
  function mainmenu() {
    return array( '<a href="'. plugin_page( 'faq_menu_page.php' ) . '" title="' . lang_get( 'menu_faq_link' ) . '"><i class="material-icons">help</i></a>' );
  }
