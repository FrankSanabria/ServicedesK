...
//	$t_email_separator2 = config_get( 'email_separator2' );
	...
	$t_message = string_get_bug_view_url_with_fqdn( $data['id'], $data['handler_id'] ) . " <br />";
	$t_message .= email_format_attribute( $p_visible_bug_data, 'email_project' ) . "<br />";
	$t_message .= email_format_attribute( $p_visible_bug_data, 'email_bug' ) . "<br />";
	$t_message .= email_format_attribute( $p_visible_bug_data, 'email_category' ) . "<br />";
	$t_message .= email_format_attribute( $p_visible_bug_data, 'email_priority' ) . "<br />";
	$t_message .= email_format_attribute( $p_visible_bug_data, 'email_status' ) . "<br /><br />";
	$t_message .= email_format_attribute( $p_visible_bug_data, 'email_summary' . "<br /><br />" );
