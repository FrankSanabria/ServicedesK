...
$pageOptions = array(
    1 => lang_get( 'plugin_MantisStats_for_ppl_cur_handlers' ),
    2 => lang_get( 'plugin_MantisStats_for_ppl_all_handlers' )
);
...
// drop-down prep
$pageOptionsDropDown = "<strong>" . lang_get( 'plugin_MantisStats_for' ) . "</strong>&nbsp;&nbsp;<select name='subType' id='subType'>";
...
if ( $selectedPageOption == 1 ) {
    $query = "
            ...
            LEFT JOIN $mantis_user_table mut ON mbt.handler_id = mut.id
...
function tables_and_charts ( $type, $output ) {
    ...
    <table class='display' id='$type' style='display:none'>
        <thead>
        <tr class='tblheader'>
            <td width='100%'>" . lang_get( 'plugin_MantisStats_handler_name' ) . "</td>";
...
<div id="wrapper">
        ...
        <div id="filter">
            ...
            <form method="get">
                <input type="hidden" name="page" value="MantisStats/people_by_handlers" />
