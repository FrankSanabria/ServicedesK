...
$query = "
        ...
        JOIN $mantis_bug_tag_table mbtt on mbt.id = mbtt.bug_id
...
EOT;
    ...
    foreach ( $data_table_totals as $key => $val ) {
        ...
        $chart_data_print .= "<set label='" . htmlspecialchars( $tag_names[$key], ENT_QUOTES ) . "' value='" . $val . "' toolText='" . number_format( $val ) . " [" . htmlspecialchars( $tag_names[$key], ENT_QUOTES ) . "]' />";
