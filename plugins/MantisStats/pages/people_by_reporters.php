...
$query = "
        SELECT mut.id, mut.realname, mut.username, count(*) AS the_count, mbt.status
...
function tables_and_charts ( $type, $output ) {
    ...
    <table class='display' id='$type' style='display:none'>
        <thead>
        <tr class='tblheader'>
            <td width='100%'>" . lang_get( 'plugin_MantisStats_reporter_name' ) . "</td>";
...
<div id="wrapper">
        ...
        <div id="filter">
            ...
            <form method="get">
                <input type="hidden" name="page" value="MantisStats/people_by_reporters" />
